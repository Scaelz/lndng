...
const speakers = [
  {
    ...
    bio: `Ирина Дмитроченкова - руководитель АНО Институт Семейной Терапии и Организационного Консультирования "ИСТОК", консультант "Статус психологии",  надёжный помощник в решении сложных проблем!
...
- Выведете себя на новый уровень коллективных вибраций!`,
  ...
  },
  {
    ...
    bio: `Лариса Николаева - буду для вас маяком на пути к счастливой семейной  жизни! 🏠 👫
<br>
...
const masters = [
  {
    ...
    bio: `Татьяна Чурсина - проводник в мир гармонии, движения и саморазвития!
<br>
