...
Через работу с мышлением помогаю раскрыть свои сильные стороны и достичь желаемых результатов. `,
  ...
  },
  {
    ...
    events: [
      ...
      "Расстановку по принятию благословения 7 колен Рода в завершении фестиваля в воскресенье",
      "Это глубинная исцеляющая практика для каждого присоединившегося, где вы сможете:<br>- увидеть, что именно в вашей системе блокирует деньги, счастливые отношения и реализацию;<br>- переупаковать ваши сценарии в желаемые;<br>- запустить перемены на практике, а не в теории",
    ],
  },
  {
    id: 13,
