...
«Рисуй не просто пейзаж — рисуй настроение!»`,
  ...
  },
  {
    ...
    bio: `Психолог, расстановщик, cпециалист гармонизации голосом, мастер глубинной коммуникации. Помогаю женщинам:`,
    bioList: [
...
Через работу с мышлением помогаю раскрыть свои сильные стороны и достичь желаемых результатов. `,
  ...
  },
  {
    ...
    bioList: [
      ...
      "После работы со мной у девушек-экспертов:<br>- появляется время, энергия и желание на целевые действия для развития своего дела<br>- доход увеличивается без выгорания, потому что уходит лишнее напряжение и суета",
    ],
    events: [
  ...
  function renderSpeakers() {
    ...
    list.forEach((speaker, index) => {
      ...
      speakerElement.innerHTML = `
                    <img style="${
                      speaker.position
                        ? `object-position: 0% ${speaker.position}%`
                        : ""
                    }" src="${speaker.photo}" alt="${
        speaker.name
